...
print("En caso de querer finalizar, luego de terminar la practica,ingrese la palabra Finalizar")
estado="" ##Variable de estado para controlar la practica y ponerle fin o seguir
while(estado!="finalizar"):
    ...
    estado=input("Para finalizar escriba: 'Finalizar'")
    estado=estado.lower()
    if (estado=="finalizar"):
